        ...
        >
            ...
            <header className="w-full px-4 py-2">
                ...
                {!isPracticeMode && !dailyWordFound && (
                    <div className="text-sm text-center font-medium mt-2">Növbəti söz: <span
                        className="font-bold">{timeUntilNextWord}</span></div>
                )}
                {isPracticeMode && (
            ...
            {/* Modals */}
            <MemoizedModal isOpen={showRules} onClose={() => setShowRules(false)}>
                <h2 className="text-2xl font-bold mb-4">Qaydalar</h2>
                <p className="mb-4">Hər gün yeni bir 5 hərfli Azərbaycan sözü təxmin etmək üçün 6 cəhdiniz var. Hər
                    cəhdinizdən sonra hərflərin yerləşdiyi yeri və hərflərin rəngini görəcəksiniz.</p>
                <div className="mb-4">
                ...
                <p className="mb-2">Oyun nəticələrinizi Twitter, WhatsApp və ya Telegram vasitəsilə paylaşa
                    bilərsiniz.</p>
                <p>Uğurlar!</p>
            </MemoizedModal>

            <MemoizedModal isOpen={showWinModal} onClose={handleCloseWinModal}>
            ...
            <MemoizedModal isOpen={showStats} onClose={() => setShowStats(false)}>
